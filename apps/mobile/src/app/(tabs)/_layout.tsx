  ...
  return (
    <Tabs
      screenOptions={{
        headerShown: false,
        /**
         * Переключение вкладок — без анимации.
         *
         * Плавное проявление здесь стоит дороже, чем выглядит: навигатор ждёт
         * конца перехода, и на время ожидания вместо экрана видна пустота. До
         * expo-router 57 эта настройка вкладками просто не читалась, поэтому
         * переключение и было мгновенным.
         */
        animation: 'none',

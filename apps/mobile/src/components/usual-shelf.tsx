...
/** Меньше трёх блюд — это не полка, а случайность: тогда её лучше не показывать. */
const MIN_DISHES = 3;

/**
 * «Как обычно» — блюда, которые этот гость берёт из раза в раз.
 *
 ...
 * первой строкой, и добавить её можно, не открывая карточку.
 *
 * Считает сервер по завершённым заказам гостя, блюдо попадает сюда после
 * второго заказа. Стоп-лист уже учтён: обещать «как обычно» и упереться в
 * «сегодня нет» — худшее, что может сделать эта полка.
 */
  ...
  return (
    ...
    >
      <View style={{ paddingHorizontal: theme.layout.screenPadding }}>
        <Text style={[theme.typography.h2, { color: theme.colors.textPrimary }]}>Как обычно</Text>
        <Text style={[theme.typography.caption, { color: theme.colors.textSecondary }]}>
          Ваши частые блюда — в одно касание
        </Text>
      </View>

...
class Settings(BaseSettings):
    ...
    # Адрес, по которому картинки видны из интернета. Нужен уведомлениям:
    # телефон грузит картинку сам, относительная ссылка ему ничего не скажет
    public_base_url: str = ""
    ...
    # Кому этот код подходит. Пусто — всем: на стенде без СМС иначе не войти.
    # Заполнить, когда появятся настоящие гости: тогда чужие номера отсекутся
